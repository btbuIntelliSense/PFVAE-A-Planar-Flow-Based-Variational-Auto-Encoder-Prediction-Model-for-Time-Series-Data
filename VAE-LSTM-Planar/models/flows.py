...
class Planar(nn.Module):
    ...
    def forward(self, zk, u, w, b):
        ...
        """
        # print('flows_u.shape', u.shape) # torch.Size([50, 24, 1])
        # print('flows_w.shape', w.shape) # torch.Size([50, 1, 24])
        # print('flows_b.shape', b.shape) # torch.Size([50, 1, 1])

        # print('1zk.shape', zk.shape) # torch.Size([50, 24])

        zk = zk.unsqueeze(2) # 图像是4维所以这里加了一个维度，时序只有三个维度，因此没有加维度
        # print('zk.shape',zk.shape) # torch.Size([50, 24, 1])
